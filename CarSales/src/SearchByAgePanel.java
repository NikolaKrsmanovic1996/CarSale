...
public class SearchByAgePanel extends JPanel implements ActionListener
{
	...
	private JLabel headingLabel = new JLabel("Pretraga po godini");
	private JLabel ageLabel = new JLabel("Godina auta");
	...
	private void searchButtonClicked()
	{
		...
		if (carList.length > 0)
		{
			...
			JOptionPane.showMessageDialog(carSystem, "Izvinjavam se nijedna pretraga nije vracena", "Search failed", JOptionPane.WARNING_MESSAGE);
	}
}