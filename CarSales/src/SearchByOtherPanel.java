...
public class SearchByOtherPanel extends JPanel implements ActionListener
{
	...
	private JLabel headingLabel = new JLabel("Pretrazi cenu i predjenu kilometrazu");
	private JLabel priceLabel = new JLabel("Cena");
	private JLabel distanceLabel = new JLabel("Predjena Kilometraza");
	private JButton searchButton = new JButton("Pretrazi");
	private JButton resetButton = new JButton("Resetuj");
	private JButton previousButton = new JButton("Prethodni");
	private JButton nextButton = new JButton("Sledeci");
	...
	private void nextButtonClicked()
	{
		if (currentIndex < carList.length - 1)
		{
			...
			JOptionPane.showMessageDialog(carSystem, "Ne mozes", "Alert", JOptionPane.ERROR_MESSAGE);
	}
	...
	private void searchButtonClicked()
	{
		...
		if (carList.length > 0)
		{
			...
			JOptionPane.showMessageDialog(carSystem, "Izvinjavamo se nijedna pretraga nije vracena", "Search failed", JOptionPane.WARNING_MESSAGE);
	}
}