...
public class WelcomePanel extends JPanel implements ChangeListener
{
	...
	private JLabel headingLabel = new JLabel("Dobrodosli u AlfaPlac", JLabel.CENTER);
	...
	private void updateStats()
	{
		...
		carsLabel.setText("Ukupan broj auta: " + String.valueOf(cars));
		manufacturersLabel.setText("Totalni broj proizvodjaca: " + String.valueOf(manufacturers));
		avgPriceLabel.setText("Prosecna Cena Vozila: " + String.valueOf(avgPrice));
		avgKmLabel.setText("Prosecna Kilometraza: " + String.valueOf(avgKm));
		avgAgeLabel.setText("Prosecna Godina Proizvodnje: " + String.valueOf(avgAge));
		dataSizeLabel.setText("Velicina data podatka: " + size + " bytes");
	}
}