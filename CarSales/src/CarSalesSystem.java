...
public class CarSalesSystem extends JFrame implements ActionListener, ComponentListener
{
	...
	private JLabel carCoLabel = new JLabel("AlfaPlac", JLabel.CENTER);
	private JLabel salesSysLabel = new JLabel("AlfaPlac automobili.com", JLabel.CENTER);
	private JTabbedPane theTab = new JTabbedPane(JTabbedPane.TOP);
	private JMenuBar menuBar = new JMenuBar();
	private JMenu fileMenu = new JMenu("O nama");
	private JMenuItem aboutItem = new JMenuItem("O nama");
	private JMenuItem exitItem = new JMenuItem("Izlas");
	...
	public CarSalesSystem(String f)
	{
		...
		theTab.add("Dobrodosli", welcomePanel);
		theTab.add("Dodaj Auto", addCarPanel);
		theTab.add("Prikazi sve marke i modele", showAllCarsPanel);
		theTab.add("Pretraga po godini", searchByAgePanel);
		theTab.add("Pretrazivanje po ceni i Predjenoj Udaljenosti", searchByOtherPanel);
	...
	public void aboutMenuItemClicked()
	{
		...
		if (aboutDlg == null)
			aboutDlg = new AboutDialog(this, "O nama", true);
		aboutDlg.showAbout();
	}
