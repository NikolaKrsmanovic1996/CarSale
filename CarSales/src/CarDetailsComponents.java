...
{
	private JLabel manufacturerLabel = new JLabel("Proizvodjac");
	private JLabel yearLabel = new JLabel("Godina");
	private JLabel modelLabel = new JLabel("Model");
	private JLabel priceLabel = new JLabel("Cena");
	private JLabel kmLabel = new JLabel("Predjana Kilometraza");
	private JLabel infoLabel = new JLabel("Dodatna Informacija");
